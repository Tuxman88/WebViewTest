#############################################################################
# Makefile for building: WebViewTest
# Generated by qmake (3.0) (Qt 5.4.1)
# Project:  WebViewTest.pro
# Template: app
# Command: /bin/qmake-qt5 -o Makefile WebViewTest.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = WebViewTest1.0.0
DISTDIR = /mnt/Cosas/Proyectos/WebViewTest/.tmp/WebViewTest1.0.0
SUBTARGETS    =  \
		release \
		debug
...
Makefile: WebViewTest.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile WebViewTest.pro
